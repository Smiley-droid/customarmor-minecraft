# Magnitude aléatoire entre 1000 et 2000 sur chaque axe
execute store result score #legendary customarmor_dx run random value 1000..2000
execute store result score #legendary customarmor_dz run random value 1000..2000
